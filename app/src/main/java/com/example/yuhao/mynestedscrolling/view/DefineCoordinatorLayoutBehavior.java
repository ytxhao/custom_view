...
public class DefineCoordinatorLayoutBehavior extends  CoordinatorLayout.Behavior<View>{

    public DefineCoordinatorLayoutBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
