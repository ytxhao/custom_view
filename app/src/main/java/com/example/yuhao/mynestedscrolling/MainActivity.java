...
import com.example.yuhao.mynestedscrolling.view.PullToRefresh;
import com.example.yuhao.mynestedscrolling.view.PullToRefreshOld;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPullToRefresh.setOnFooterRefreshListener(new PullToRefresh.OnFooterRefreshListener() {
            ...
            public void onFooterRefresh(PullToRefresh view) {
                ...
                mPullToRefresh.setIsHeaderLoad(false);
